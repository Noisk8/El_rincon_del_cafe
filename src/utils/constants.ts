export const backgroundGradientColor =
  "bg-gradient-to-tr from-amber-50 to-blue-50";
export const textGradient =
  "text-transparent bg-clip-text bg-gradient-to-tr from-main via-main to-orange-dimmed";
